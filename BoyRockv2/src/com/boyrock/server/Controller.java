...
import com.boyrock.consts.ConstIgnoreName;
...
import com.boyrock.services.func.UseItem;
import com.boyrock.utils.Logger;
import com.boyrock.utils.Util;
import com.girlkun.database.GirlkunDB;
import com.girlkun.result.GirlkunResultSet;

import static com.boyrock.services.func.Input.CHOOSE_LEVEL_BDKB;
import static com.boyrock.services.func.Input.NUMERIC;
...
public class Controller implements IMessageHandler {
    ...
    if (player != null) {
        try {
            for (int i = 0; i < 12; i++) {
                if (_msg.reader().available() >= 1) { // Kiểm tra nếu còn ít nhất 1 byte dữ liệu để đọc
    ...
    break;
                ...
                case 34:
                    if (player != null) {
                        ...
                        if( selectSkill == Skill.BIEN_KHI ||  selectSkill == Skill.HUYT_SAO || selectSkill == Skill.BIEN_BROLY || selectSkill == Skill.VO_HIEU_CHUONG || selectSkill == Skill.TIEN_HOA){
