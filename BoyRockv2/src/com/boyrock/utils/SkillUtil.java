package com.boyrock.utils;

import java.util.List;

import com.boyrock.models.Template.SkillTemplate;
...
public static int getTimeBroly(int level) { //thời gian tồn tại khỉ v
        return (level + 5) * 10000;
    }
public static int getTimetienhoa(int level) { //thời gian tồn tại khỉ v
        return (level + 5) * 5000;
    }
    public static int getPercentHpMonkey(int level) { //tỉ lệ máu khỉ cộng thêm v
        return (level + 3) * 10;
    }
     public static int getPercentHpBroly(int level) { //tỉ lệ máu khỉ cộng thêm v
        return (level + 3) * 10;
    }
     public static int getPercentKiBroly(int level) { //tỉ lệ máu khỉ cộng thêm v
        return (level + 3) * 10;
    }

    public static int getPercentDameBroly(int level) { //tỉ lệ dam khỉ cộng thêm v
        return (level + 3);
    }
...
public static int getTimeHoabang(int level) {
         return (level + 4) * 1000;
    }
...
//        return 10000;
    ...
    public static byte getTempSkillSkillByItemID(int id) {
        ...
        } else if (id  >= 1444 && id <= 1450) {
            return Skill.BIEN_BROLY;
        } else {
            return -1;
        }
    }
...
//        return (level + 2) * 1000;
    ...
    public static int getTimeVohieu(int level) { //thời gian tồn tại khiên v
        return (level + 2) * 10000;
//        return (level + 2) * 1000;
    }
    public static Skill getSkillByItemID(Player pl, int tempId) {
        if (tempId >= 66 && tempId <= 72) {
         ...
         else if (tempId >= 1444 && tempId <= 1450) {
            return getSkillbyId(pl, Skill.BIEN_BROLY);
