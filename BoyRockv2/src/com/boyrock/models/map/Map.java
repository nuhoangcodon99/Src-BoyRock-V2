...
import com.boyrock.models.boss.list_boss.nappa.MapDauDinh;
        ...
        for (Zone zone : zones) {
            ...
            switch (this.mapId) {
                ...
                case 91: //7 sao đen
                    ...
                    break;
                case 206: //7 sao đen
                     itemMap = new ItemMap(zone, 1387, 1, 1342, 288, -1);
                  
                      itemMap = new ItemMap(zone, 1388, 1, 1347, 288, -1);
                  
                       itemMap = new ItemMap(zone, 1389, 1, 1353, 288, -1);
                  
                        itemMap = new ItemMap(zone, 1390, 1, 1358, 288, -1);
                   itemMap = new ItemMap(zone, 1391, 1, 1363, 288, -1);
                   itemMap = new ItemMap(zone, 1392, 1, 1368, 288, -1);
                  
                    itemMap = new ItemMap(zone, 1393, 1, 1373, 288, -1);
                    break;
            }
        }
