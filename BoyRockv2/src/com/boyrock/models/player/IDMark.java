...
public class IDMark {
   ...
   private int getVodaiBallNumber ;
   private int setVodaiBallNumber;
    
    
    
    private long lastTimeNotifyTimeHoldVodaiBall;
    private long lastTimeHoldVodaiBall;
    private int tempIdVodaiBallHold = -1;
    private boolean holdVodaiBall;
