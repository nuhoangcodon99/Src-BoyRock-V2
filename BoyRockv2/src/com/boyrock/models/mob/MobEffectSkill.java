...
public class MobEffectSkill {
    ...
    public void update() {
        ...
        if (isHoaLanh && (Util.canDoWithTime(lastTimeHoaLanh, timeHoaLanh) || mob.isDie())) {
            removeHoaLanh();
        }
...
public void removeHoaLanh() {
        Message msg;
        this.isHoaLanh = false;
        try {
            msg = new Message(-112);
            msg.writer().writeByte(0);
            msg.writer().writeByte(mob.id);
    ...
    public void setSocola(long lastTimeSocola, int timeSocola) {
      ...
      public void setHoaLanh(long lastTimeHoaLanh, int timeHoaLanh) {
        this.lastTimeHoaLanh = lastTimeHoaLanh;
        this.timeHoaLanh = timeHoaLanh;
        this.isHoaLanh = true;
    }
