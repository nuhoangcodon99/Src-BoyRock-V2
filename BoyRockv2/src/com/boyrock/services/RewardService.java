...
import com.boyrock.models.Template.ItemLuckyRound;
import com.boyrock.models.Template.ItemOptionLuckyRound;
...
public class RewardService {
    ...
    private static final int[][][] ACTIVATION_SET = {
        ...
        {{135, 138, 1, 1000}, {133, 136, 1, 1000}, {134, 137, 1, 1000}}, //kakarot - cadic - nappa
             ...
             {{212, 224, 1, 1000}, {210, 222, 1, 1000}, {211, 223, 1, 1000}}, //songoku - thien xin hang - kirin
        {{214, 226, 1, 1000}, {215, 227, 1, 1000}, {213, 225, 1, 1000}}, //oc tieu - pikkoro daimao - picolo
        {{216, 219, 1, 1000}, {217, 220, 1, 1000}, {218, 221, 1, 1000}} //kakarot - cadic - nappa
    };
