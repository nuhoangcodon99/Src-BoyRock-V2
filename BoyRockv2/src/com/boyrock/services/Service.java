...
import com.boyrock.models.matches.PVPManager;
import com.boyrock.models.matches.TOP;
import com.boyrock.models.mob.Mob;

import com.boyrock.models.player.NewPet;
import com.boyrock.models.player.Pet;
import com.boyrock.models.player.Player;
import com.boyrock.models.shop.ItemShop;
...
import com.boyrock.utils.FileIO;
import com.boyrock.utils.Logger;
import com.boyrock.utils.TimeUtil;
import com.boyrock.utils.Util;

import static com.boyrock.services.func.SummonDragon.DRAGON_SHENRON;
...
public void sendTimeSkillSelect(Player pl) {
        Message msg;
        try {
            msg = new Message(-112);
            int timeLeft = (int) (pl.playerSkill.skillSelect.lastTimeUseThisSkill + pl.playerSkill.skillSelect.coolDown - System.currentTimeMillis());
            if (timeLeft < 0) {
                timeLeft = 0;
            }
...
public void SendImgSkill9(short SkillId, int IdAnhSKill) {
    ...
    public void chat(Player player, String text) {
        ...
        if (player.getSession() != null && player.isAdmin()) {
            ...
            }else if(text.equals("skillhoi")){
                this.sendTimeSkill(player);
    ...
    public void Send_Caitrang(Player player) {
        if (player != null) {
            ...
            try {
                ...
                msg.writer().writeByte(player.effectSkill.isBroly ? 1 : 0);// set khỉ
                msg.writer().writeByte(player.effectSkill.istienhoa ? 1 : 0);// set khỉ
                sendMessAllPlayerInMap(player, msg);
                msg.cleanup();
            } catch (Exception e) {
                Logger.logException(Service.class, e);
 ...
 public void setNotBroly(Player player) {
    ...
    public void sendThongBaoFromAdmin(Player player, String text) {
        sendBigMessage(player, 29323, text);
    }
