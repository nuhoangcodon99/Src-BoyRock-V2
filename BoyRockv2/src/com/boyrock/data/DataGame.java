...
import com.boyrock.models.Template.HeadAvatar;
import com.boyrock.models.Template.MapTemplate;
import com.boyrock.models.Template.MobTemplate;
import com.boyrock.models.Template.NpcTemplate;
...
public static void sendRes(MySession session) {
    ...
    try {
        if (session != null && session.isConnected()) {
            ...
            Logger.logException(DataGame.class, new NullPointerException("Session is null or disconnected"));
        }
    } catch (Exception e) {
        Logger.logException(DataGame.class, e);
    }
